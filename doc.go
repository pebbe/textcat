...
Many built-in language models are based on frequency lists, see:

    http://en.wiktionary.org/wiki/Wiktionary:Frequency_lists

Most of these lists are based on www.opensubtitles.org, see:
...
Languages: eo fy ga gd hi ia ja kk ko la lb sw ta tl vi vo yi yo zh
